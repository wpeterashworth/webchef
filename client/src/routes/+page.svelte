<script>
  ...
  import HeroSection from "$lib/components/landing.svelte";
  ...
  const actionHref = $derived($user ? "/lesson" : "/signup");
</script>

<Header />

<main class="main">
  <HeroSection heroSrc="/images/kitchenHero.webp" {description} {actionHref} />
</main>
